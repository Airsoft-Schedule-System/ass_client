...
import { findParticipationForUserAndSession } from '@/api/participations/participations';
...
import { findSessionById } from '@/api/sessions/sessions';
import type { SessionDetail } from '@/api/sessions/sessions';
        ...
        <section className="flex flex-col gap-3 rounded-2xl border border-[var(--color-app-border)] bg-[var(--color-app-surface)] p-4">
          ...
          {participation && (
            <div className="flex items-center justify-between gap-3 border-t border-[var(--color-app-border)] pt-3">
              ...
              <GameStatusBadge status={participation.status} />
            </div>
          )}
        </section>
